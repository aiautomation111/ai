...
export const auditDevServiceData: ServiceData = {
  hero: {
    title: "What is an Tech audit?",
    description: `In today's digital landscape, high-performance technology services are no longer a luxury but a cornerstone for the success of any business. A "Technology Services Review" provides a strategic and in-depth assessment of your current technology services, aiming to unleash their full potential. <br/> <br/> Our team of multidisciplinary experts meticulously analyzes every aspect of your technology services, from user interface (UI) and user experience (UX) design to the underlying software infrastructure and overall performance. The results of this analysis are benchmarked against your specific business objectives to ensure alignment and drive impactful results. Furthermore, a specialized security review can identify any vulnerabilities and strengthen your technological infrastructure's defenses against potential threats. <br/> <br/> The ultimate goal is to provide you with a clear roadmap of actionable insights. We identify immediate improvements ("quick wins") and establish a long-term strategy to significantly enhance the value, performance, and user satisfaction of your technology services.`,
  img: "1.png"
  },
  features: {
    imageUrl: "https://images.unsplash.com/photo-1556740738-b6a63e27c4df?q=80&w=2070",
